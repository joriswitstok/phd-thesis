...
\newcommand{\Ha}{{H\ensuremath{\upalpha}}}
\newcommand{\Hb}{{H\ensuremath{\upbeta}}}
\newcommand{\NII}{{[\ion{N}{II}]}}
\newcommand{\SII}{{[\ion{S}{II}]}}
\newcommand{\OI}{{[\ion{O}{I}]}}

\newcommand{\Angstrom}{\ensuremath{\AA}}
...
\RequirePackage[small, labelfont=bf, labelsep=space, tableposition=top]{caption}
...
\ifuseCustomBib
   ...
   %\RequirePackage[comma, sort&compress, authoryear]{natbib} % CustomBib
   %\RequirePackage[comma, sort&compress, numbers]{natbib} % CustomBib
