...
% Drafts
%\documentclass[a4paper, 12pt, twoside, draft, index, PageStyleII, times, custombib]{PhDThesisPSnPDF}
%\documentclass[a4paper, 11pt, oneside, draft, chapter, nolineno, index, PageStyleII, times, custombib]{PhDThesisPSnPDF}
%\documentclass[a4paper, 11pt, twoside, print, draft, nolineno, custommargin, index, PageStyleII, times, custombib]{PhDThesisPSnPDF}
