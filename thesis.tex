...
% Drafts
%\documentclass[a4paper, 12pt, twoside, draft, index, PageStyleII, customfont, custombib]{PhDThesisPSnPDF}
%\documentclass[a4paper, 11pt, oneside, draft, chapter, nolineno, index, PageStyleII, customfont, custombib]{PhDThesisPSnPDF}
%\documentclass[a4paper, 11pt, twoside, print, draft, nolineno, custommargin, index, PageStyleII, customfont, custombib]{PhDThesisPSnPDF}

% Online version
\documentclass[a4paper, 11pt, twoside, index, PageStyleII, customfont, custombib]{PhDThesisPSnPDF}

% Print version
%\documentclass[a4paper, 11pt, twoside, print, index, PageStyleII, customfont, custombib]{PhDThesisPSnPDF}
% custommargin only works with non-default pagestyle if included here, not via \pagestyle!

% Declaration/abstract only
%\documentclass[a4paper, 11pt, print, declaration, customfont]{PhDThesisPSnPDF}
%\documentclass[a4paper, 11pt, print, abstract, customfont]{PhDThesisPSnPDF}
